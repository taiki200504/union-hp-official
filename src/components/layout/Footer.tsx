        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-lg font-bold">UNION</span>
            </div>
            <p className="text-gray-400 text-sm">学生の声を社会に響かせる</p>
          </div>
          <div>
            <h3 className="font-semibold mb-4">サービス</h3>
            <ul className="space-y-2 text-sm text-gray-400">
              <li>
                <Link href="/services#student" className="hover:text-white">
                  学生向けサービス
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mb-2">gakusei.union226@gmail.com</p>
            <div className="flex space-x-4 mt-4">
              <a
                href="https://twitter.com/union_official"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/union_official"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white"
              >
              ...
              <a
                href="https://www.youtube.com/channel/union_official"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white"
              >
